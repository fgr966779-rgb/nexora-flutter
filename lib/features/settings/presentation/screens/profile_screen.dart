    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _settingsTile(icon: Icons.family_restroom_rounded, title: 'Моя сім\'я', subtitle: 'Керування групою та спільні цілі', trailing: Icon(Icons.chevron_right_rounded, color: hintColor, size: 20), onTap: () { HapticService.selection(); Navigator.of(context).pushNamed('/family'); }, cardColor: cardColor, borderColor: borderColor, textColor: textColor, subColor: subColor, hintColor: hintColor),
          _settingsTile(icon: Icons.school_rounded, title: 'Академія Nexora', subtitle: 'Навчайся та отримуй XP', trailing: Icon(Icons.chevron_right_rounded, color: hintColor, size: 20), onTap: () { HapticService.selection(); Navigator.of(context).pushNamed(AppRoutes.academy); }, cardColor: cardColor, borderColor: borderColor, textColor: textColor, subColor: subColor, hintColor: hintColor),
          _settingsTile(icon: Icons.auto_awesome_rounded, title: 'Розумні заощадження', subtitle: 'Округлення та авто-правила', trailing: Icon(Icons.chevron_right_rounded, color: hintColor, size: 20), onTap: () { HapticService.selection(); Navigator.of(context).pushNamed(AppRoutes.smartSavings); }, cardColor: cardColor, borderColor: borderColor, textColor: textColor, subColor: subColor, hintColor: hintColor),
